...
const mockHabitats = [
    ...
    { id: 2, title: 'Африка',
        ...
        picture_url: 'http://127.0.0.1:9000/test/Африка.jpg' },
    ...
    return (
        <div className="bg-[#060F1E] font-roboto min-h-screen">
            ...
            <div className="font-roboto text-white ml-8 mt-12">
                <h1 className="text-3xl font-bold">Информация о континенте: {habitat.title}</h1>
                <div className="max-w-3xl mt-5">
                    <img
                        className="w-64 h-48 rounded-lg float-right ml-2.5"
                        src={habitat.picture_url}
                        alt={habitat.title}
                    />
                    <p className="w-full text-lg">{habitat.description}</p>
                </div>
            </div>
        </div>
    );
